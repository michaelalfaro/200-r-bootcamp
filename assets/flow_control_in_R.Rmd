...
We have only scratched the surface in exploring the power of R to wrangle data. For more practice and guided tutorials on R data fundamentals check out the Software Carpentry site [here](http://swcarpentry.github.io/r-novice-inflammation/01-starting-with-data/index.html). In addition there is a popular and powerful set of tools for working with data wrapped up in a set of packages called the tidyverse. This is my preferred way for working with data now. If you want to learn the tidyverse tools you can start at [this](https://ucla-data-archive.github.io/intro-r-tidyv/) UCLA tidyverse course site and [here](https://www.datacamp.com/community/tutorials/tidyverse-tutorial-r) and [here](https://www.analyticsvidhya.com/blog/2019/05/beginner-guide-tidyverse-most-powerful-collection-r-packages-data-science/). Please also let me know if you find sites that are especailly helpful and I will share them with the class.
...
perform an action as long as a specified condition is true.
```{r eval=FALSE}
...
Of course there are a large number of web resoures to help you learn various aspects of R programming. I like the Software Carpentry site [here](http://swcarpentry.github.io/r-novice-inflammation/02-func-R/index.html). Please send me other sites you find useful and I can share them with the class.
