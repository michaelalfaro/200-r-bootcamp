...
- 9:15-10:30 Introduction Basic Statistics and Plotting in R [slides]({{ site.baseurl }}/assets/Pinter_Wollman_2021.pdf) *Pinter-Wollman*
	...
	- just the lecture [R code]({{ site.baseurl }}/assets/pinter-wollman_code_2021.R)
...
- 10:30AM - 12:00PM Flow control, scripts, functions *Alfaro* [slides]({{ site.baseurl }}/assets/flow_control_in_R.html)
	...
	- Alfaro's [problem set #1]({{site.baseurl}}/assets/bootcamp_exercises_1_control.pdf)
	- Alfaro's [problem set #2]({{site.baseurl}}/assets/bootcamp_alfaro_problem_set_2_2021.pdf)
